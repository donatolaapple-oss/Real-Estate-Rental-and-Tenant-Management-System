...
import { StayScoutLandlordNav } from "../../components/StayScoutNav";
      ...
      <header className="sticky top-0 z-50 flex flex-wrap items-center justify-between gap-3 px-4 py-3 bg-white/95 backdrop-blur border-b border-slate-200 shadow-sm">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-slate-500">Landlord profile</p>
          </div>
        </div>
        <StayScoutLandlordNav />
      </header>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <dl className="space-y-3 text-sm">
            ...
            <div>
              ...
              <dd className="font-medium text-slate-900">{user?.phoneNumber || "—"}</dd>
            </div>
          </dl>
          <Link
